...
{
    [TestClass]
    public class Modulo_GARABI_ITASSA1_LimiteINFGARABI1
    {
        private string nomeFuncao = "Modulo_GARABI_ITASSA1-LimiteINFGARABI1";
        /// <summary>
        ...
        public void ExecutarComDados()
        {
            ...
            for (int i = 0; i < mediador.linhas_SUL.Count; i++)
            {
                ...
                Assert.AreEqual(limite.GetValue(), mediador.linhas_SUL[i].LDvalorplanilha_LimGrbiIINFExport);
            }
        }
