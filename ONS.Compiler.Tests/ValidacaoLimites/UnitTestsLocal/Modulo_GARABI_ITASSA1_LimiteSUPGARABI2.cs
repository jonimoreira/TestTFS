...
{
    [TestClass]
    public class Modulo_GARABI_ITASSA1_LimiteSUPGARABI2
    {
        private string nomeFuncao = "Modulo_GARABI_ITASSA1-LimiteSUPGARABI2";
        /// <summary>
        ...
        public void AtualizarVariaveisDaMemoriaDeCalculo()
        {
            ...
            {
                AtualizarVariaveisDaMemoriaDeCalculo(maquinaInequacoes, mediador.linhas_SUL[i]);
            }
        ...
        public void ExecutarComDados()
        {
            ...
            for (int i = 0; i < mediador.linhas_SUL.Count; i++)
            {
                ...
                Assert.AreEqual(limite.GetValue(), mediador.linhas_SUL[i].LDvalorplanilha_LimGrbiIISUPImport);
            }
        }
        ...
        public void AtualizarVariaveisDaMemoriaDeCalculo(InequationEngine maquinaInequacoes, SheetRow_SUL sheetRow_SUL)
        {
            maquinaInequacoes.CalculationMemory.UpdateVariable("xGarabi1", sheetRow_SUL.MC_Grbi_I);
            maquinaInequacoes.CalculationMemory.UpdateVariable("xGarabi2", sheetRow_SUL.MC_Grbi_II);
        }
        ...
        {
            Mediador.SetVariavelValor(memoriaCalculo, "xGarabi1", sheetRow_SUL.MC_Grbi_I);
            Mediador.SetVariavelValor(memoriaCalculo, "xGarabi2", sheetRow_SUL.MC_Grbi_II);
        }
