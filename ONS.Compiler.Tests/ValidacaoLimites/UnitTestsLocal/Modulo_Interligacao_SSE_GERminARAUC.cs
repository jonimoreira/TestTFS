...
{
    [TestClass]
    public class Modulo_Interligacao_SSE_GERminARAUC
    {
        private string nomeFuncao = "Modulo_Interligacao_SSE-GERminARAUC";
        /// <summary>
        ...
        public void ExecutarComDados()
        {
            ...
            for (int i = 0; i < mediador.linhas_S_SE.Count; i++)
            {
                ...
                Assert.AreEqual(limite.GetValue(), mediador.linhas_SUL[i].LDvalorplanilha_GeracaoMinimaAraucara);
            }
        }
