...
{
    [TestClass]
    public class Modulo_N_NE_apoio_Limite_Inf_EXPN_IO_NNE
    {
        private string nomeFuncao = "Modulo_N_NE_apoio-Limite_Inf_EXPN_IO_NNE";
        /// <summary>
        ...
        public void ExecutarComDados()
        {
            ...
            for (int i = 0; i < mediador.linhas_N_NE_SE.Count; i++)
            {
                ...
                Assert.AreEqual(limite.GetValue(), mediador.linhas_N_NE_SE[i].LDvalorplanilha_LimiteEXPN_INF);
            }
        }
