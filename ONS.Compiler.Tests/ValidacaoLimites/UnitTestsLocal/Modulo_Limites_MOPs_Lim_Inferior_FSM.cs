...
{
    [TestClass]
    public class Modulo_Limites_MOPs_Lim_Inferior_FSM
    {
        private string nomeFuncao = "Modulo_Limites_MOPs-Lim_Inferior_FSM";
        /// <summary>
        ...
        public void AtualizarVariaveisDaMemoriaDeCalculo(InequationEngine maquinaInequacoes, SheetRow_N_NE_SE sheetRow_N_NE_SE, SheetRow_S_SE sheetRow_S_SE)
        {
            ...
            maquinaInequacoes.CalculationMemory.UpdateVariable("xugSM", sheetRow_N_NE_SE.MC_SMGerando);
