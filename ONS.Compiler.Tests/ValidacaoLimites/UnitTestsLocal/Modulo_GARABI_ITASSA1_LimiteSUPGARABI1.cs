...
{
    [TestClass]
    public class Modulo_GARABI_ITASSA1_LimiteSUPGARABI1
    {
        private string nomeFuncao = "Modulo_GARABI_ITASSA1-LimiteSUPGARABI1";
        /// <summary>
        ...
        public void Executar()
        {
            ...
            Assert.AreEqual(limite.GetValue(), 1000.0);
        }
        ...
        public void ExecutarComDados()
        {
            ...
            for (int i = 0; i < mediador.linhas_SUL.Count; i++)
            {
                ...
                Assert.AreEqual(limite.GetValue(), mediador.linhas_SUL[i].LDvalorplanilha_LimGrbiISUPImport);
            }
        }
        ...
        {
            maquinaInequacoes.CalculationMemory.UpdateVariable("garabi1", sheetRow_SUL.MC_Grbi_I);
        }
        ...
        {
            Mediador.SetVariavelValor(memoriaCalculo, "garabi1", sheetRow_SUL.MC_Grbi_I);
        }
