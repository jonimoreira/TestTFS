...
{
    [TestClass]
    public class Modulo_Interligacao_SSE_LimiteFSE
    {
        private string nomeFuncao = "Modulo_Interligacao_SSE-LimiteFSE";
        ...
        {
            Mediador.SetVariavelValor(memoriaCalculo, "xMaqIpu", sheetRow_S_SE.MC_Mq_60Hz);
