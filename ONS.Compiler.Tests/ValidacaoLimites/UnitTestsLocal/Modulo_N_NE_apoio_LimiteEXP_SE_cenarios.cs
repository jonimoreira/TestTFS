...
{
    [TestClass]
    public class Modulo_N_NE_apoio_LimiteEXP_SE_cenarios
    {
        private string nomeFuncao = "Modulo_N_NE_apoio-LimiteEXP_SE_cenarios";
        /// <summary>
        ...
        public void Executar()
        {
            ...
            Assert.AreEqual(limite.GetValue(), 5000.0);
        }
        ...
        public void ExecutarComDados()
        {
            ...
            for (int i = 0; i < mediador.linhas_N_NE_SE.Count; i++)
            {
                ...
                Assert.AreEqual(limite.GetValue(), mediador.linhas_N_NE_SE[i].LDvalorplanilha_LimiteEXP_SE_Sup);
            }
        }
        ...
        public void AtualizarVariaveisDaMemoriaDeCalculo(InequationEngine maquinaInequacoes, SheetRow_N_NE_SE sheetRow_N_NE_SE)
        {
            ...
            maquinaInequacoes.CalculationMemory.UpdateVariable("xEXP_SE", sheetRow_N_NE_SE.MC_EXP_SE);
            maquinaInequacoes.CalculationMemory.UpdateVariable("xPpecem", sheetRow_N_NE_SE.MC_Gera_Porto_Pecem);
