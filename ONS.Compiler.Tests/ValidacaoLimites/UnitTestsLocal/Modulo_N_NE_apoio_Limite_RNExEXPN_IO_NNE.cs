...
{
    [TestClass]
    public class Modulo_N_NE_apoio_Limite_RNExEXPN_IO_NNE
    {
        private string nomeFuncao = "Modulo_N_NE_apoio-Limite_RNExEXPN_IO_NNE";
        /// <summary>
        ...
        public void Executar()
        {
            ...
            Assert.AreEqual(limite.GetValue(), 4300.0);
        }
