...
namespace Ciloci.Flee
{
	...
	public sealed class ExpressionContext
	{
        ...
        /*
        public List<IDynamicExpression> CompileDynamic(Dictionary<int, string> expressions)
        {
            List<IDynamicExpression> expressionsCompiled = new List<IDynamicExpression>();
            this.Options.EmitToAssembly = false;

            foreach (string expression in expressions.Values)
            {
                IDynamicExpression dynamicExp = new Expression<object>(expression, this, false);
                expressionsCompiled.Add(dynamicExp);
            }

            return expressionsCompiled;
        }
        */
